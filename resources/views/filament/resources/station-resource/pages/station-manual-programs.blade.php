    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium mb-2">Имя программы</label>
                    <input 
                        type="text" 
            ...
            <div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            @foreach($signals as $rowIndex => $row)
                                <tr class="border-b dark:border-gray-700">
            ...
            <div>
                <label class="block text-sm font-medium mb-2">задержка в минутах</label>
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse">
                        <thead>
                            <tr class="border-b dark:border-gray-700">
                        ...
                        <tbody>
                            @foreach($delays as $rowIndex => $row)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="p-2 text-center">{{ $rowIndex + 1 }}</td>
                                    @foreach($row as $colIndex => $value)
                                        <td class="p-2">
